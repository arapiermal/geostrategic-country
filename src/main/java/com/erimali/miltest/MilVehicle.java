...
public class MilVehicle {
    ...
    public MilVehicle(byte type, String name, String desc) {
        this.id = CURR_ID++;
        this.lvl = 1;
        this.type = type;
        this.name = name;
    ...
    public MilVehicle(String loc) throws Exception{
    ...
    public void attackUnit(MilVehicle o, boolean attacking){
    ...
    public void attackUnits(MilVehicle... opponent){
        for(MilVehicle o : opponent)

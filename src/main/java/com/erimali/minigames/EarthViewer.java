...
public class EarthViewer extends Application {
	...
	private static final String DIFFUSE_MAP = Paths.get("src/main/resources/map/2k_earth_daymap.jpg").toAbsolutePath().toString();
	private static final String NORMAL_MAP = Paths.get("src/main/resources/map/2k_earth_normal_map.jpg").toAbsolutePath().toString();
	private static final String SPECULAR_MAP = Paths.get("src/main/resources/map/2k_earth_specular_map.jpg").toAbsolutePath().toString();

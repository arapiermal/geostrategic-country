...
public class GlobeViewer extends Stage {
	...
	private String[] DIFFUSE_MAP = { GLogic.RESOURCESPATH+"map/2k_earth_daymap.jpg",
			"resources/map/2k_moon.jpg",
			"resources/map/2k_sun.jpg"};
	private String[] NORMAL_MAP = { GLogic.RESOURCESPATH+"map/2k_earth_normal_map.jpg" };
	private String[] SPECULAR_MAP = { GLogic.RESOURCESPATH+"map/2k_earth_specular_map.jpg" };

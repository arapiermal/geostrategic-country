...
public enum WarObjective {
    ...
    ANNEX(100) {
        ...
        public void action(CountryArray cArr1, int ind1, CountryArray cArr2, int ind2, double warState, int... args) {
            //factors that effect?
        ...
        public void action(Country c1, Country c2, double warState, int... args) {
            //c1.annexCountry(c2);
        }
    },
    //types???
